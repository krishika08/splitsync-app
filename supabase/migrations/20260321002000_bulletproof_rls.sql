...
-- 1) Create fast bypass functions
create or replace function public.is_group_member_fast(_group_id uuid, _user_id uuid)
returns boolean
...
create or replace function public.is_group_creator_fast(_group_id uuid, _user_id uuid)
returns boolean
language sql stable security definer
set search_path = public
set row_security = off
